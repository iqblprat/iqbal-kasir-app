        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td width="5%"><?= $no++ ?></td>
                        <td width="50%"><?= ucwords($row['iqbal_nama_barang']) ?></td>
                        <td width="10%"><?= $row['iqbal_qty'] ?></td>
                        <td width="15%">Rp <?= number_format($row['iqbal_harga_barang'], 2, ',', '.') ?></td>
                        <td width="15%">Rp <?= number_format($subtotal, 2, ',', '.') ?></td>
                    </tr>
                <?php } ?>
                <tr>
                    <td colspan="4" class="text-end"><b>Total Harga (<?= $jumlah_barang ?> item)</b></td>
